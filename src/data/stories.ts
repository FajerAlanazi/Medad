...
// ─── Story 3: My Country's Flag ─────────────────────────────────────────────
export const flagStory: Story = {
  id: "flag-symbols-riyadh",
  title: "يوم جنى الأول: سر العلم الأخضر",
  subject: "الدراسات الاجتماعية والمواطنة — علم بلادي ورموزه الوطنية",
  grade: "الصف الأول الابتدائي",
  region: "مدرسة في الرياض",
  regionEmoji: "🇸🇦",
  difficulty: "سهل",
  duration: "١٠ دقائق",
  description: "أول يوم لجنى في مدرستها — تكتشف مع صديقتها شهد سر علم بلادها ومعنى رموزه الوطنية",
  cover: "https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=800&h=450&fit=crop&auto=format",
  mapPosition: { x: 40, y: 30 },
  concepts: ["لون العلم ومكوناته", "سبب عدم تنكيس العلم", "معنى السيف بالعلم", "الشعار الوطني"],
  startNode: "intro",
  nodes: {
    intro: {
      id: "intro",
      type: "narrative",
      scene: "طابور الصباح",
      title: "أول يوم بالمدرسة",
      text: "في أول يوم لجنى في مدرستها الجديدة بالرياض، وقفت مع زميلاتها في طابور الصباح، وشعرت بالحيرة حين رأت الجميع يقفون بهدوء وينظرون لأعلى السارية. همست لصديقتها الجديدة شهد: «لماذا يقف الجميع هكذا؟»\n\nابتسمت شهد وقالت: «ننتظر رفع علم بلادنا يا جنى، هذا نفعله كل صباح». نظرت جنى للأعلى فرأت علماً أخضر يرتفع ببطء، مكتوب عليه بخط أبيض جميل، وتحت الكتابة سيف أبيض.",
      xp: 10,
      next: "flag_color_question",
    },
    flag_color_question: {
      id: "flag_color_question",
      type: "question",
      scene: "طابور الصباح",
      title: "ما لون العلم؟",
      text: "ما لون علم المملكة العربية السعودية الذي رأته جنى؟",
      concept: "لون العلم ومكوناته",
      hint: "تذكّري وصف جنى للعلم وهو يرتفع فوق السارية.",
      choices: [
        { text: "أخضر", correct: true, feedback: "صحيح! العلم أخضر اللون، ومكتوب عليه الشهادتان بخط أبيض.", points: 30, next: "teacher_explains" },
        { text: "أزرق", correct: false, feedback: "غير صحيح، لون العلم أخضر وليس أزرق.", points: 10, next: "teacher_explains" },
        { text: "أحمر", correct: false, feedback: "غير صحيح، لون العلم أخضر وليس أحمر.", points: 10, next: "teacher_explains" },
      ],
    },
    teacher_explains: {
      id: "teacher_explains",
      type: "narrative",
      scene: "بعد انتهاء الطابور",
      title: "شرح الأستاذة منال",
      text: "اقتربت الأستاذة منال بعد انتهاء الطابور وسألت جنى: «هل أعجبك علم وطننا؟» أجابت جنى: «نعم، لكن ماذا يعني المكتوب عليه؟» أوضحت الأستاذة: «هذه الشهادتان: لا إله إلا الله محمد رسول الله، ولهذا فإن علمنا خاص جداً، فهو الوحيد الذي لا يُنزَّل إلى منتصف السارية حتى في المناسبات الحزينة، احتراماً لما هو مكتوب عليه».",
      concept: "الشهادتان",
      xp: 15,
      next: "tanqees_choice",
    },
    tanqees_choice: {
      ...
      scene: "بعد انتهاء الطابور",
      title: "سؤال شهد",
      text: "لماذا لا يُنزَّل علم المملكة أبداً إلى منتصف السارية، حتى في المناسبات الحزينة؟",
      concept: "سبب عدم تنكيس العلم",
      hint: "تذكّري ماذا قالت الأستاذة منال عن الكتابة على العلم.",
      choices: [
        { text: "لأنه يحمل الشهادتين", correct: true, feedback: "صحيح! هذا احترام لما هو مكتوب عليه من الشهادتين.", points: 40, next: "sword_meaning" },
        { text: "لأنه غالي الثمن", correct: false, feedback: "غير صحيح، السبب مرتبط بما هو مكتوب على العلم لا بثمنه.", points: 15, next: "sword_meaning" },
        { text: "لأنه كبير الحجم", correct: false, feedback: "غير صحيح، السبب هو احترام الشهادتين المكتوبتين عليه.", points: 15, next: "sword_meaning" },
      ],
    },
    sword_meaning: {
      id: "sword_meaning",
      type: "narrative",
      scene: "بعد انتهاء الطابور",
      title: "السيف تحت الشهادتين",
      text: "سألت جنى بفضول: «وهذا السيف تحته، ماذا يعني؟» قالت الأستاذة: «السيف يرمز للقوة والعدل التي تحمي بلادنا».",
      concept: "معنى السيف بالعلم",
      xp: 15,
      next: "emblem_intro",
    },
    emblem_intro: {
      id: "emblem_intro",
      type: "narrative",
      scene: "الطريق إلى الفصل",
      title: "الشعار فوق باب المدرسة",
      text: "في طريقهما إلى الفصل، لاحظت جنى شعاراً صغيراً فوق باب المدرسة، فيه سيفان متقاطعان ونخلة بينهما. سألت: «وهذا أيضاً جزء من العلم؟» ضحكت شهد وقالت: «لا، هذا الشعار الوطني لبلادنا، السيفان يرمزان للقوة، والنخلة ترمز للخير والعطاء، تجدينه في كل مكان رسمي».",
      concept: "الشعار الوطني",
      xp: 20,
      next: "emblem_match",
    },
    emblem_match: {
      ...
      type: "match",
      scene: "الشعار الوطني",
      title: "وصّلي كل رمز بمعناه",
      text: "وصّلي كل رمز من الشعار الوطني بالمعنى الصحيح له.",
      concept: "الشعار الوطني",
      hint: "تذكّري كلام شهد عن السيفين والنخلة.",
      xp: 25,
      matchPairs: [
        { term: "السيفان", definition: "القوة والعدل" },
        { term: "النخلة", definition: "الخير والنماء" },
      ],
      next: "ending",
    },
    ending: {
      id: "ending",
      type: "ending",
      scene: "المنزل، آخر اليوم",
      title: "فخورة بوطنها",
      text: "في نهاية اليوم، عادت جنى إلى بيتها وأخبرت أمها بكل ما تعلمته، وقالت بفخر: «اليوم عرفت لماذا علمنا مميز عن كل الأعلام». احتضنتها أمها وقالت: «والآن أصبحتِ تعرفين كيف تحترمين رمز وطنك يا جنى».",
      xp: 100,
    },
  },
};

// ─── Story 4: National Day ──────────────────────────────────────────────────
export const nationalDayStory: Story = {
  id: "national-day-riyadh",
  title: "زينة اليوم الوطني عند ريم",
  subject: "الدراسات الاجتماعية والمواطنة — اليوم الوطني للمملكة العربية السعودية",
  grade: "الصف الأول الابتدائي",
  region: "منزل في الرياض",
  regionEmoji: "🇸🇦",
  difficulty: "سهل",
  duration: "١٠ دقائق",
  description: "ريم وأخوها بندر يجهّزون بيتهم لليوم الوطني، ويكتشفون مع والدهم قصة توحيد المملكة",
  cover: "https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=800&h=450&fit=crop&auto=format",
  mapPosition: { x: 45, y: 35 },
  concepts: ["أعلام ورموز الاحتفال", "معنى اليوم الوطني", "توحيد المملكة وتاريخه", "ألوان الاحتفال"],
  startNode: "n1",
  nodes: {
    n1: {
      id: "n1",
      ...
      scene: "منزل ريم",
      title: "صندوق الزينة",
      text: "قبل أيام من الثالث والعشرين من سبتمبر، دخلت ريم المنزل فوجدت والدها يحمل صندوقاً كبيراً مليئاً بالأعلام الصغيرة والأضواء الخضراء والبيضاء. سألت بحماس: «بابا، ماذا نحضّر؟»",
      xp: 15,
      next: "n2",
    },
    n2: {
      ...
      scene: "منزل ريم",
      title: "ماذا بالصندوق؟",
      text: "ماذا كان بالصندوق الذي أحضره والد ريم؟",
      concept: "أعلام ورموز الاحتفال",
      hint: "تذكّري وصف الصندوق بالفقرة اللي قبل.",
      choices: [
        { text: "أعلام صغيرة وأضواء خضراء وبيضاء", correct: true, feedback: "صحيح! هذي رموز زينة اليوم الوطني.", points: 25, next: "n3" },
        { text: "ألعاب وحلويات", correct: false, feedback: "غير صحيح، الصندوق كان فيه أعلام وأضواء للاحتفال.", points: 10, next: "n3" },
        { text: "كتب مدرسية", correct: false, feedback: "غير صحيح، الصندوق كان فيه أعلام وأضواء للاحتفال.", points: 10, next: "n3" },
      ],
    },
    n3: {
      id: "n3",
      ...
      scene: "منزل ريم",
      title: "مناسبة عزيزة",
      text: "أجاب الأب: «نجهّز البيت للاحتفال باليوم الوطني لبلادنا يا ريم، هذا اليوم مناسبة عزيزة على كل سعودي». انضم أخوها بندر وسأل: «ولماذا نحتفل بالتحديد في هذا اليوم؟»",
      concept: "معنى اليوم الوطني",
      xp: 15,
      next: "n4",
    },
    n4: {
      ...
      type: "question",
      scene: "منزل ريم",
      title: "لماذا نجهّز البيت؟",
      text: "لماذا يجهّز الأب البيت بهذه الزينة؟",
      concept: "معنى اليوم الوطني",
      hint: "تذكّري ماذا قال الأب لريم.",
      choices: [
        { text: "للاحتفال باليوم الوطني لأنه مناسبة عزيزة على كل سعودي", correct: true, feedback: "صحيح! اليوم الوطني مناسبة يحتفل بها كل أهل الوطن.", points: 25, next: "n5" },
        { text: "لاستقبال ضيوف عاديين", correct: false, feedback: "غير صحيح، السبب هو الاحتفال باليوم الوطني.", points: 10, next: "n5" },
        { text: "لتنظيف المنزل فقط", correct: false, feedback: "غير صحيح، الزينة خاصة بمناسبة اليوم الوطني.", points: 10, next: "n5" },
      ],
    },
    n5: {
      id: "n5",
      ...
      scene: "منزل ريم",
      title: "قصة التوحيد",
      text: "جلس الأب معهما وشرح: «منذ زمن بعيد، كانت أرضنا مقسّمة إلى مناطق متفرقة، حتى جاء الملك عبدالعزيز آل سعود وعمل بجهد كبير على توحيدها في دولة واحدة قوية، وفي الثالث والعشرين من سبتمبر عام ١٩٣٢م، أُعلن قيام المملكة العربية السعودية الموحدة».",
      concept: "توحيد المملكة وتاريخه",
      xp: 20,
      next: "n6",
    },
    n6: {
      ...
      type: "choice",
      scene: "منزل ريم",
      title: "متى أُعلنت المملكة؟",
      text: "في أي تاريخ أُعلن قيام المملكة العربية السعودية الموحدة؟",
      concept: "توحيد المملكة وتاريخه",
      hint: "التاريخ مذكور بكلام الأب بالفقرة اللي قبل.",
      choices: [
        { text: "٢٣ سبتمبر ١٩٣٢م", correct: true, feedback: "صحيح! هذا تاريخ إعلان قيام المملكة الموحدة على يد الملك عبدالعزيز.", points: 30, next: "n7" },
        { text: "١ يناير ١٩٥٠م", correct: false, feedback: "غير صحيح، التاريخ الصحيح هو ٢٣ سبتمبر ١٩٣٢م.", points: 10, next: "n7" },
        { text: "٥ رمضان", correct: false, feedback: "غير صحيح، التاريخ الصحيح هو ٢٣ سبتمبر ١٩٣٢م.", points: 10, next: "n7" },
      ],
    },
    n7: {
      id: "n7",
      ...
      scene: "منزل ريم",
      title: "لون الزينة",
      text: "سألت ريم: «ولهذا نزيّن البيت بالأخضر والأبيض؟» أجاب الأب: «نعم، هذان لونا علمنا، ونستخدمهما في زينة اليوم الوطني تعبيراً عن فرحتنا وانتمائنا».",
      concept: "ألوان الاحتفال",
      xp: 15,
      next: "n8",
    },
    n8: {
      ...
      type: "question",
      scene: "منزل ريم",
      title: "لماذا الأخضر والأبيض؟",
      text: "لماذا يزيّن الناس بيوتهم باللونين الأخضر والأبيض في اليوم الوطني؟",
      concept: "ألوان الاحتفال",
      hint: "تذكّري إجابة الأب لريم.",
      choices: [
        { text: "لأنهما لونا علم المملكة", correct: true, feedback: "صحيح! الزينة بلوني العلم تعبير عن الفخر والانتماء.", points: 25, next: "n9" },
        { text: "لأنهما لونا الشتاء", correct: false, feedback: "غير صحيح، السبب أنهما لونا علم المملكة.", points: 10, next: "n9" },
        { text: "لأنهما أرخص الألوان", correct: false, feedback: "غير صحيح، السبب أنهما لونا علم المملكة.", points: 10, next: "n9" },
      ],
    },
    n9: {
      id: "n9",
      type: "ending",
      scene: "مساء اليوم الوطني",
      title: "فرحة الانتماء",
      text: "في مساء اليوم الوطني، جلست العائلة كلها معاً، والسماء تتلألأ بالألعاب النارية الخضراء والبيضاء، وقالت ريم وهي تصفّق بفرح: «أشعر أنني محظوظة لأنني من هذا الوطن الجميل!» ابتسم والدها وقال: «وهذا بالضبط معنى الاحتفال يا ريم، أن نشعر بالفخر والانتماء كل عام».",
      xp: 100,
    },
  },
};

export const stories: Story[] = [waterCycleStory, foodChainsStory, flagStory, nationalDayStory];
...
export const subjectPresets = [
  ...
  {
    subject: "الدراسات الاجتماعية والمواطنة",
    lesson: "علم بلادي ورموزه الوطنية",
    grade: "الصف الأول",
    icon: "🇸🇦",
    color: "from-green-900 to-emerald-900",
    story: "flag-symbols-riyadh",
    region: "مدرسة في الرياض",
    regionEmoji: "🇸🇦",
    difficulty: "سهل" as const,
    duration: "١٠ دقائق",
  ...
  {
    subject: "الدراسات الاجتماعية والمواطنة",
    lesson: "اليوم الوطني للمملكة",
    grade: "الصف الأول",
    icon: "🎆",
    color: "from-green-900 to-teal-900",
    story: "national-day-riyadh",
    region: "منزل في الرياض",
    regionEmoji: "🇸🇦",
    difficulty: "سهل" as const,
    duration: "١٠ دقائق",
